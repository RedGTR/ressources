//META{"name":"RedStatut","source":"https://raw.githubusercontent.com/toluschr/BetterDiscord-Animated-Status/master/Animated_Status.plugin.js","website":"https://darkgtr.tk"}*//

class RedStatut {
	/* BD functions */
	getName() { return "RedGTR_ Custom Statut"; }
	getVersion() { return "0.00.2"; }
	getAuthor() { return "redgtr"; }
	getDescription() { return "Animate your Discord status"; }

	SetData(key, value) {
		BdApi.setData("RedStatut", key, value);
	}

	GetData(key) {
		return BdApi.getData("RedStatut", key);
	}
	...
	load() {
		...
		this.modules = this.modules || (() => {
			let m = []
			webpackChunkdiscord_app.push([['RedStatut'], {}, e => { m = m.concat(Object.values(e.c)) }])
			return m
		})();
